...
import 'package:rsue_food_app/routes/register_routes.dart';
import 'package:rsue_food_app/utils/helper/background_service_helper.dart';
import 'package:rsue_food_app/utils/helper/database_helper.dart';
import 'package:rsue_food_app/utils/helper/notification_helper.dart';
import 'package:rsue_food_app/utils/helper/preference_settings_helper.dart';
import 'package:rsue_food_app/utils/navigation.dart';
import 'package:rsue_food_app/utils/provider/notification_scheduling_provider.dart';
      ...
      providers: [
        ...
        ChangeNotifierProvider(
          create: (_) => RestaurantFavoriteProvider(
              databaseHelper: DatabaseHelper(), userProvider: UserProvider()),
        ),
        ChangeNotifierProvider(
